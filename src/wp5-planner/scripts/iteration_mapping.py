...
class iteration(object):
    ...
    def mapping(self, x, y, para):
        ...
        for i in range(k):
            ...
            # position iteration
                ...
                # print('up_bound:', up_bound.shape)
                x0 = np.array([up_bound/10,0.5])      #---wr ensure x0 is 1D array           # initial values for [rho, belta]
                # print('x0:', x0.shape)
                # x0 = x0.flatten() 
                # print('x0:', x0.shape)
    ...
    #         # orientation iteration
            ...
            x0 = np.array([0.5, 0.5]) #---wr ensure x0 is 1D array
