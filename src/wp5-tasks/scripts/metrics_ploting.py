...
class DataSubscriber:
    ...
    def plot_data(self, force_data, desired_twist_data, actual_twist_data, actual_pose_data):
        ...
        plt.subplot(2, 2, 2)
        plt.plot(eef_time, twist_linear_x_desired[:eef_size], label='Linear X Desired')
        plt.plot(eef_time, twist_linear_y_desired[:eef_size], label='Linear Y Desired')
        plt.plot(eef_time, twist_linear_z_desired[:eef_size], label='Linear Z Desired')
        plt.plot(eef_time, twist_linear_x_actual[:eef_size], label='Linear X Actual')
        plt.plot(eef_time, twist_linear_y_actual[:eef_size], label='Linear Y Actual')
        plt.plot(eef_time, twist_linear_z_actual[:eef_size], label='Linear Z Actual')
        plt.xlabel('Index')
        ...
        # Plot RMSE
        plt.subplot(2, 2, 4)
        plt.plot(eef_time, rmse_at_each_step[:eef_size], label='RMSE')
        plt.xlabel('Time (s)')
        plt.ylabel('RMSE')
        ...
        plt.tight_layout()
        plt.savefig("../plots/" + str(start_time) + ".png")
        plt.show()
