...
struct player_ : public msm::front::state_machine_def<player_> {
  ...
  struct transition_table
      : mpl::vector<
            ...
            a_row<Playing::exit_pt<Playing_::CDFinished>, AllSongsPlayed, Stopped, &p::end_playback>,
            //  +-------------+---------------+---------+---------------------+----------------------+
...
void pstate(player const& p) {
  ...
  mpl::for_each<all_states, boost::msm::wrap<mpl::placeholders::_1> >(msm::back::fill_state_names<Stt>(state_names));
